...
Сценарий: поиск пользователей по роли
	...
	| Медведева | Медсестра      |
	| Путин     | Врач,Админ     |
	| Кабаева   | Врач,Медсестра |
	| Сабчак    | Медсестра      |
	Когда ищут пользователей с ролью "Админ"
	Тогда возвращается следующий список пользователей
	| имя      |
	| Медведев |
	| Путин    |

Сценарий: поиск пользователей по роли и части имени
	Пусть существуют роли
	| имя       |
	| Врач      |
	| Медсестра |
	...
	| имя       | роли             |
	| Медведев  | Админ            |
	| Медведева | Медсестра, Админ |
	| Путин     | Врач,Админ       |
	| Кабаева   | Врач,Медсестра   |
	| Сабчак    | Медсестра        |
	Когда ищут пользователей по части имени "едведев" и по роли "Админ" 
	Тогда возвращается следующий список пользователей
	| имя       |
	| Медведев  |
	| Медведева |
